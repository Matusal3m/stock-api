...
CREATE INDEX `user_id_idx` ON `categories` (`userId`);--> statement-breakpoint
CREATE INDEX `stock_id_idx` ON `categories` (`stockId`);--> statement-breakpoint
ALTER TABLE `products` ADD `userId` integer REFERENCES users(id);--> statement-breakpoint
CREATE INDEX `user_id_idx` ON `products` (`userId`);--> statement-breakpoint
CREATE INDEX `stock_id_idx` ON `products` (`stockId`);--> statement-breakpoint
...
CREATE INDEX `user_id_idx` ON `stocks` (`userId`);